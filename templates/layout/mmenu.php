<div class="menu-res">
    ...
    <nav id="menu">
        <ul>
            ...
            <?php if(config('product.san-pham') !== null){ ?>
                <li>
                ...
                <li class="menu-line"></li>
            <?php } ?>
            <?php if(isset($config['news']['tin-tuc'])){ ?>
                <li>
                ...
                <li class="menu-line"></li>
            <?php } ?>
            <?php if(isset($config['news']['dich-vu'])){ ?>
                <li>
